...
<x-app-layout>
    <div class="container">
        ...
        <p class="text-muted">Gerencie os modelos de avaliação e as recuperações que você criou.</p>
        <hr class="mt-0">
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                {{-- Link para a página de detalhes, que será a mesma do coordenador --}}
                                <a href="{{ route('coordenador.modelos.show', $modelo) }}" class="btn btn-dark w-100 mb-2">Gerenciar Modelo</a>

                                <form action="{{ route('professor.avaliacoes.destroy', $modelo) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir este modelo?');">
                                    @csrf
                                    @method('DELETE')
        ...
        @else
            <div class="alert alert-info" role="alert">
                Você ainda não criou nenhum modelo de avaliação.
            </div>
        @endif
    </div>
</x-app-layout>