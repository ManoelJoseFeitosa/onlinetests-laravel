...
<head>
    ...
    <title>@yield('title', 'MaFe Provas Online') - MaFe Provas Online</title>
        ...
        <div class="container text-center text-md-start">
            <div class="row text-center text-md-start">
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 fw-bold text-primary">MaFe Provas Online</h5>
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-envelope-fill me-3"></i>contato@mafesistemas.com.br</p>
                    <p>
            ...
            <div class="row align-items-center">
                <div class="col-md-7 col-lg-8">
                    <p class="text-center text-md-start mb-3 mb-md-0">Copyright © 2025 MaFe Sistemas. Todos os direitos reservados.</p>
                </div>
